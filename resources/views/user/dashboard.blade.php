...
<head>
    ...
    <link href="{{ asset('user_dashboard_assets/css/owl.css') }}" rel="stylesheet">
    <link href="{{ asset('user_dashboard_assets/css/nice-select.css') }}" rel="stylesheet">
    <!-- Style css -->
    <link href="{{ asset('user_dashboard_assets/css/style.css') }}" rel="stylesheet">
    <style type="text/css">
        .apexcharts-canvas {
            position: relative;
            user-select: none;
...
<body data-typography="poppins" data-theme-version="light" data-layout="vertical" data-nav-headerbg="color_1"
        ...
        ***********************************-->
        <div class="nav-header">
            <a href="index.html" class="brand-logo"> 
               <img src="{{ asset('user_dashboard_assets/image/zhivago-logo.png')}}" alt=""class="img-responsive" style="width:200px; height:auto;">
            </a>
                ...
                <div class="tab-content">
                    <div class="tab-pane fade active show" id="chat" role="tabpanel">
                        <div class="card mb-sm-3 mb-md-0 contacts_card dz-chat-user-box">
                            <div class="card-header chat-list-header text-center"> <a href="javascript:void(0);">
                            ...
                            <div class="card-body contacts_body p-0 dz-scroll ps ps--active-y" id="DZ_W_Contacts_Body">
                                <ul class="contacts">
                                    ...
                                    <li class="active dz-chat-user">
                                        <div class="d-flex bd-highlight">
                                            <div class="img_cont"> <img src="{{ asset('user_dashboard_assets/image/1.jpg')}}"
                                                    class="rounded-circle user_img" alt=""> <span
                                                    class="online_icon"></span> </div>
                                            <div class="user_info"> <span>Archie Parker</span>
                                                <p>Kalid is online</p>
                                            </div>
                                        </div>
                                    </li>
                                    <li class="dz-chat-user">
                                        <div class="d-flex bd-highlight">
                                            <div class="img_cont"> <img src="{{ asset('user_dashboard_assets/image/2.jpg')}}"
                                                    class="rounded-circle user_img" alt=""> <span
                                                    class="online_icon offline"></span> </div>
                                            <div class="user_info"> <span>Alfie Mason</span>
                                    ...
                                    <li class="dz-chat-user">
                                        <div class="d-flex bd-highlight">
                                            <div class="img_cont"> 
                                                <img src="{{ asset('user_dashboard_assets/image/3.jpg')}}"class="rounded-circle user_img" alt=""> 
                                    ...
                                    <li class="dz-chat-user">
                                        <div class="d-flex bd-highlight">
                                            <div class="img_cont"> 
                                                <img src="{{ asset('user_dashboard_assets/image/4.jpg')}}"class="rounded-circle user_img" alt=""> 
                                    ...
                                    <li class="dz-chat-user">
                                        <div class="d-flex bd-highlight">
                                            <div class="img_cont"> 
                                                <img src="{{ asset('user_dashboard_assets/image/5.jpg')}}"class="rounded-circle user_img" alt=""> 
                                                <span class="online_icon offline"></span> 
                                            </div>
                                            <div class="user_info"> 
                                    ...
                                    <li class="dz-chat-user">
                                        <div class="d-flex bd-highlight">
                                            <div class="img_cont"> <img src="{{ asset('user_dashboard_assets/image/1.jpg')}}"
                                                    class="rounded-circle user_img" alt=""> <span
                                                    class="online_icon"></span> </div>
                                            <div class="user_info"> <span>Breddie Ronan</span>
                                                <p>Kalid is online</p>
                                            </div>
                                        </div>
                                    </li>
                                    <li class="dz-chat-user">
                                        <div class="d-flex bd-highlight">
                                            <div class="img_cont"> <img src="{{ asset('user_dashboard_assets/image/2.jpg')}}"
                                                    class="rounded-circle user_img" alt=""> <span
                                                    class="online_icon offline"></span> </div>
                                            <div class="user_info"> <span>Ceorge Carson</span>
                                                <p>Taherah left 7 mins ago</p>
                                            </div>
                                        </div>
                                    </li>
                                    ...
                                    <li class="dz-chat-user">
                                        <div class="d-flex bd-highlight">
                                            <div class="img_cont"> <img src="{{ asset('user_dashboard_assets/image/3.jpg')}}"
                                                    class="rounded-circle user_img" alt=""> <span
                                                    class="online_icon"></span> </div>
                                            <div class="user_info"> <span>Darry Parker</span>
                                                <p>Sami is online</p>
                                            </div>
                                        </div>
                                    </li>
                                    <li class="dz-chat-user">
                                        <div class="d-flex bd-highlight">
                                            <div class="img_cont"> <img src="{{ asset('user_dashboard_assets/image/4.jpg')}}"
                                                    class="rounded-circle user_img" alt=""> <span
                                                    class="online_icon offline"></span> </div>
                                            <div class="user_info"> <span>Denry Hunter</span>
                                                <p>Nargis left 30 mins ago</p>
                                            </div>
                                        </div>
                                    </li>
                                    ...
                                    <li class="dz-chat-user">
                                        <div class="d-flex bd-highlight">
                                            <div class="img_cont"> <img src="{{ asset('user_dashboard_assets/image/5.jpg')}}"
                                                    class="rounded-circle user_img" alt=""> <span
                                                    class="online_icon offline"></span> </div>
                                            <div class="user_info"> <span>Jack Ronan</span>
                                                <p>Rashid left 50 mins ago</p>
                                            </div>
                                        </div>
                                    </li>
                                    <li class="dz-chat-user">
                                        <div class="d-flex bd-highlight">
                                            <div class="img_cont"> <img src="{{ asset('user_dashboard_assets/image/1.jpg')}}"
                                                    class="rounded-circle user_img" alt=""> <span
                                                    class="online_icon"></span> </div>
                                            <div class="user_info"> <span>Jacob Tucker</span>
                                                <p>Kalid is online</p>
                                            </div>
                                        </div>
                                    </li>
                                    <li class="dz-chat-user">
                                        <div class="d-flex bd-highlight">
                                            <div class="img_cont"> <img src="{{ asset('user_dashboard_assets/image/2.jpg')}}"
                                                    class="rounded-circle user_img" alt=""> <span
                                                    class="online_icon offline"></span> </div>
                                            <div class="user_info"> <span>James Logan</span>
                                                <p>Taherah left 7 mins ago</p>
                                            </div>
                                        </div>
                                    </li>
                                    <li class="dz-chat-user">
                                        <div class="d-flex bd-highlight">
                                            <div class="img_cont"> <img src="{{ asset('user_dashboard_assets/image/3.jpg')}}"
                                                    class="rounded-circle user_img" alt=""> <span
                                                    class="online_icon"></span> </div>
                                            <div class="user_info"> <span>Joshua Weston</span>
                                                <p>Sami is online</p>
                                            </div>
                                        </div>
                                    </li>
                                    ...
                                    <li class="dz-chat-user">
                                        <div class="d-flex bd-highlight">
                                            <div class="img_cont"> <img src="{{ asset('user_dashboard_assets/image/4.jpg')}}"
                                                    class="rounded-circle user_img" alt=""> <span
                                                    class="online_icon offline"></span> </div>
                                            <div class="user_info"> <span>Oliver Acker</span>
                                                <p>Nargis left 30 mins ago</p>
                                            </div>
                                        </div>
                                    </li>
                                    <li class="dz-chat-user">
                                        <div class="d-flex bd-highlight">
                                            <div class="img_cont"> <img src="{{ asset('user_dashboard_assets/image/5.jpg')}}"
                                                    class="rounded-circle user_img" alt=""> <span
                                                    class="online_icon offline"></span> </div>
                                            <div class="user_info"> <span>Oscar Weston</span>
                                                <p>Rashid left 50 mins ago</p>
                                            </div>
                                        </div>
                                    </li>
                                ...
                                <div class="ps__rail-y" style="top: 0px; height: 835px; right: 0px;">
                                    <div class="ps__thumb-y" tabindex="0" style="top: 0px; height: 715px;"></div>
                                </div>
                            </div>
                        </div>
                        <div class="card chat dz-chat-history-box d-none">
                            <div class="card-header chat-list-header text-center"> <a href="javascript:void(0);"
                                ...
                                <div class="dropdown"> <a href="javascript:void(0);" data-bs-toggle="dropdown"
                                        aria-expanded="false">
                                        <svg xmlns="http://www.w3.org/2000/svg" xlink="http://www.w3.org/1999/xlink"
                                            width="18px" height="18px" viewBox="0 0 24 24" version="1.1">
                                            <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                            ...
                            <div class="card-body msg_card_body dz-scroll ps" id="DZ_W_Contacts_Body3"
                                ...
                                <div class="d-flex justify-content-start mb-4">
                                    <div class="img_cont_msg"> <img src="{{ asset('user_dashboard_assets/image/1.jpg')}}"
                                            class="rounded-circle user_img_msg" alt=""> </div>
                                    <div class="msg_cotainer"> Hi, how are you samim? <span class="msg_time">8:40 AM,
                                            Today</span> </div>
                                </div>
                                <div class="d-flex justify-content-end mb-4">
                                    <div class="msg_cotainer_send"> Hi Khalid i am good tnx how about you? <span
                                            class="msg_time_send">8:55 AM, Today</span> </div>
                                    <div class="img_cont_msg"> <img src="{{ asset('user_dashboard_assets/image/2.jpg')}}"
                                            class="rounded-circle user_img_msg" alt=""> </div>
                                </div>
                                <div class="d-flex justify-content-start mb-4">
                                    <div class="img_cont_msg"> <img src="{{ asset('user_dashboard_assets/image/1.jpg')}}"
                                    ...
                                    <div class="msg_cotainer"> I am good too, thank you for your chat template <span
                                            class="msg_time">9:00 AM, Today</span> </div>
                                </div>
                                <div class="d-flex justify-content-end mb-4">
                                    <div class="msg_cotainer_send"> You are welcome <span class="msg_time_send">9:05 AM,
                                            Today</span> </div>
                                    <div class="img_cont_msg"> <img src="{{ asset('user_dashboard_assets/image/2.jpg')}}"
                                            class="rounded-circle user_img_msg" alt=""> </div>
                                </div>
                                <div class="d-flex justify-content-start mb-4">
                                    <div class="img_cont_msg"> <img src="{{ asset('user_dashboard_assets/image/1.jpg')}}"
                                            class="rounded-circle user_img_msg" alt=""> </div>
                                    <div class="msg_cotainer"> I am looking for your next templates <span
                                            class="msg_time">9:07 AM, Today</span> </div>
                                </div>
                                <div class="d-flex justify-content-end mb-4">
                                    <div class="msg_cotainer_send"> Ok, thank you have a good day <span
                                ...
                                <div class="d-flex justify-content-start mb-4">
                                    <div class="img_cont_msg"> <img src="{{ asset('user_dashboard_assets/image/1.jpg')}}"
                                            class="rounded-circle user_img_msg" alt=""> </div>
                                    <div class="msg_cotainer"> Bye, see you <span class="msg_time">9:12 AM, Today</span>
                                    </div>
                                </div>
                                <div class="d-flex justify-content-start mb-4">
                                    <div class="img_cont_msg"> <img src="{{ asset('user_dashboard_assets/image/1.jpg')}}"
                                ...
                                <ul class="contacts">
                                    ...
                                    <li class="active">
                                        <div class="d-flex bd-highlight">
                                            ...
                                            <div class="user_info"> <span>David Nester Birthday</span>
                                    ...
                                    <li>
                                        <div class="d-flex bd-highlight">
                                            ...
                                            <div class="user_info"> <span>Perfection Simplified</span>
                                    ...
                                    <li>
                                        <div class="d-flex bd-highlight">
                                            ...
                                            <div class="user_info"> <span>AharlieKane</span>
                                                <p>Sami is online</p>
                                            </div>
                                        </div>
                                    </li>
                                    <li>
                                        <div class="d-flex bd-highlight">
                                            ...
                                            <div class="user_info"> <span>Athan Jacoby</span>
                                                <p>Nargis left 30 mins ago</p>
                                            </div>
                                        </div>
                                    </li>
                        ...
                        <div class="card mb-sm-3 mb-md-0 note_card">
                            ...
                            <div class="card-body contacts_body p-0 dz-scroll ps" id="DZ_W_Contacts_Body2">
                                <ul class="contacts">
                                    <li class="active">
                                        <div class="d-flex bd-highlight">
                                            <div class="user_info"> <span>New order placed..</span>
                                                <p>10 Aug 2020</p>
                                            </div>
                                            <div class="ms-auto"> <a href="javascript:void(0);"
                                                    ...
                                                    class="btn btn-danger btn-xs sharp"><i class="fa fa-trash"></i></a>
                                            </div>
                                        </div>
                                    </li>
                                    <li>
                                        <div class="d-flex bd-highlight">
                                            <div class="user_info"> <span>Youtube, a video-sharing website..</span>
                                                <p>10 Aug 2020</p>
                                            </div>
                                            <div class="ms-auto"> <a href="javascript:void(0);"
                                                    class="btn btn-primary btn-xs sharp me-1"><i
                                    ...
                                    <li>
                                        <div class="d-flex bd-highlight">
                                            <div class="user_info"> <span>john just buy your product..</span>
                                                <p>10 Aug 2020</p>
                                            </div>
                                            <div class="ms-auto"> <a href="javascript:void(0);"
                                                    class="btn btn-primary btn-xs sharp me-1"><i
                        ...
                        <ul class="navbar-nav header-right">
                            ...
                            <li class="nav-item dropdown notification_dropdown"> 
                                ...
                                <div class="dropdown-menu bg-dark ">
                                    <div id="DZ_W_Notification1" class="widget-media dz-scroll p-3 text-center ps"
                                        style="height:380px;">
                                        <ul class="timeline">
                                            <li>
                                            ...
                                            <li>
                                                <div class="timeline-panel">
                                                    <div class="media-body">
                                                        <a href="#">
                                                            <h6 class="mb-1 text-white">Trade</h6>
                                                        </a>
                                                    </div>
                                                </div>
                                            </li>
                                            <li>
                                                <div class="timeline-panel">
                                                    <div class="media-body">
                                                        <a href="#">
                                                            <h6 class="mb-1 text-white">Crypto</h6>
                                                        </a>
                                                    </div>
                                                </div>
                                            </li>
                                            <li>
                                                <div class="timeline-panel">
                                                    <div class="media-body">
                                                        <a href="#">
                                                            <h6 class="mb-1 text-white">Zelle</h6>
                                                        </a>
                                                    </div>
                                                </div>
                                            </li>
                                            <li>
                                                <div class="timeline-panel">
                                                    <div class="media-body">
                                                        <a href="#">
                                                            <h6 class="mb-1 text-white">Venmo</h6>
                                                        </a>
                                                    </div>
                                                </div>
                                            </li>
                                            <li>
                                                <div class="timeline-panel">
                                                    <div class="media-body">
                                                        <a href="#">
                                                            <h6 class="mb-1 text-white">Deposit in store</h6>
                                                        </a>
                                                    </div>
                                                </div>
                                            </li>
                                            <li>
                                                <div class="timeline-panel">
                                                    <div class="media-body">
                                                        <a href="#">
                                                            <h6 class="mb-1 text-white">Cashapp</h6>
                                                        </a>
                                                    </div>
                                                </div>
                                            </li>
                                            {{-- <li>
                                                <div class="timeline-panel">
                                                    <div class="media me-2"> <img alt="image" src="{{ asset('user_dashboard_assets/image/1.jpg')}}"
                                                            width="50"> </div>
                                                    <div class="media-body">
                                ...
                                <div class="dropdown-menu dropdown-menu-end">
                                    <div id="DZ_W_Notification1" class="widget-media dz-scroll p-3 ps"
                                        ...
                                        <ul class="timeline">
                                            ...
                                            <li>
                                                <div class="timeline-panel">
                                                    <div class="media me-2 media-success"> <i class="fa fa-home"></i>
                                                    </div>
                                                    <div class="media-body">
                                            ...
                                            <li>
                                                <div class="timeline-panel">
                                                    <div class="media me-2 media-primary"> <i class="fa fa-home"></i>
                                                    </div>
                                                    <div class="media-body">
                                                        <h6 class="mb-1">Reminder : Treatment Time!</h6>
                                                        <small class="d-block">29 July 2020 - 02:26 PM</small>
                            ...
                            <li class="nav-item dropdown notification_dropdown"> <a class="nav-link bell-link ai-icon"
                                    ...
                                    <span class="badge light text-white bg-primary rounded-circle">5</span> </a> </li>
                            <li class="nav-item dropdown notification_dropdown"> <a class="nav-link ai-icon"
                                    ...
                                    <span class="badge light text-white bg-primary rounded-circle">2</span> </a>
                                <div class="dropdown-menu dropdown-menu-end">
                                    <div id="DZ_W_TimeLine02"
                                        class="widget-timeline dz-scroll style-1 ps p-3 height370">
                                        <ul class="timeline">
                                            <li>
        ...
        ***********************************-->
        <div class="deznav">
            <div class="deznav-scroll mm-active ps ps--active-y">
                <div class="dropdown header-profile"> <a class="nav-link" href="javascript:void(0);" role="button"
                        data-bs-toggle="dropdown"> <img src="{{ asset('uploads/userProfileImage')}}/{{ $profileImage->image }}" alt="" width="20">
                        <div class="header-info"> <span class="font-w400 mb-0">Hello,<b>{{ Auth::user()->name }}</b></span> <small
                                class="text-end font-w400">{{ Auth::user()->email }}</small> </div>
                    </a>
                    <div class="dropdown-menu dropdown-menu-end">
                ...
                <ul class="metismenu mm-show" id="menu">
                    <li class="mm-active"><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
                            <i class="flaticon-025-dashboard"></i> <span class="nav-text">Dashboard</span> </a>
                        <ul aria-expanded="false" class="mm-collapse mm-show">
                            ...
                            <li><a href="tranasactions.html">Tranasactions</a></li>
                            <li><a href="portofolio.html">Portofolio</a></li>
                            <li><a href="market-capital.html">Market Capital</a></li>
                        </ul>
                    </li>
                    <li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false"> <i
                                class="flaticon-050-info"></i> <span class="nav-text">Apps</span> </a>
                    ...
                    <li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false"> <i
                                class="flaticon-041-graph"></i> <span class="nav-text">Charts</span> </a>
                        <ul aria-expanded="false" class="mm-collapse">
                    ...
                    <li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false"> <i
                                class="flaticon-086-star"></i> <span class="nav-text">Bootstrap</span> </a>
                        <ul aria-expanded="false" class="mm-collapse">
                    ...
                    <li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false"> <i
                                class="flaticon-045-heart"></i> <span class="nav-text">Plugins</span> </a>
                        <ul aria-expanded="false" class="mm-collapse">
                    ...
                    <li><a href="widget-basic.html" class="ai-icon" aria-expanded="false"> <i
                                class="flaticon-013-checkmark"></i> <span class="nav-text">Widget</span> </a> </li>
                    <li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false"> <i
                                class="flaticon-072-printer"></i> <span class="nav-text">Forms</span> </a>
                        <ul aria-expanded="false" class="mm-collapse">
                    ...
                    <li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false"> <i
                                class="flaticon-043-menu"></i> <span class="nav-text">Table</span> </a>
                        <ul aria-expanded="false" class="mm-collapse">
                    ...
                    <li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false"> <i
                                class="flaticon-022-copy"></i> <span class="nav-text">Pages</span> </a>
                        <ul aria-expanded="false" class="mm-collapse">
                ...
                <div class="copyright">
                    <p><strong>Boltz Crypto Admin Dashboard</strong> © 2021 All Rights Reserved</p>
                ...
                <div class="ps__rail-y" style="top: 0px; height: 835px; right: 0px;">
                    <div class="ps__thumb-y" tabindex="0" style="top: 0px; height: 655px;"></div>
                </div>
            </div>
        </div>
        <!--**********************************
        ...
        <div class="content-body" style="min-height: 1116px;">
            ...
            <div class="container-fluid">
                <div class="mb-sm-4 d-flex flex-wrap align-items-center text-head">
                    ...
                    <div class="weather-btn mb-2"> <span class="fs-22 font-w600 d-flex"><i
                                class="fa fa-cloud me-3 ms-3"></i>21</span>
                        <select class="form-control style-3 default-select" style="display: none;">
                            <option selected="selected">Medan, IDN</option>
                            <option>Jakarta, IDN</option>
                            <option>Surabaya, IDN</option>
                        </select>
                        <div class="nice-select form-control style-3 default-select" tabindex="0"><span
                                class="current">Medan, IDN</span>
                            <ul class="list">
                                <li data-value="Medan, IDN" class="option selected">Medan, IDN</li>
                                <li data-value="Jakarta, IDN" class="option">Jakarta, IDN</li>
                                <li data-value="Surabaya, IDN" class="option">Surabaya, IDN</li>
                            </ul>
                        </div>
                    </div>
                                ...
                                <div>
                                    ...
                                    <p class="mb-0 invoice-num1">
                                        <svg width="21" height="14" viewBox="0 0 21 14" fill="none"
                                            xmlns="http://www.w3.org/2000/svg">
                                            <path d="M1 13C1.91797 11.9157 4.89728 8.72772 6.5 7L12.5 10L19.5 1"
                                                stroke="#13B440" stroke-width="2" stroke-linecap="round"></path>
                                        </svg>
                                        <span class="text-success me-1">45%</span> This week </p>
                                </div>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="card-body d-flex">
                                <div class="icon me-3">
                                    <svg width="60" height="60" viewBox="0 0 60 60" fill="none"
                                        xmlns="http://www.w3.org/2000/svg">
                                        <g opacity="0.99">
                                            <circle cx="30" cy="30.0001" r="30" fill="white"></circle>
                                            <path
                            ...
                            <div class="card-body d-flex">
                                ...
                                <div>
                                    ...
                                    <p class="mb-0">
                                        <svg width="21" height="14" viewBox="0 0 21 14" fill="none"
                                            xmlns="http://www.w3.org/2000/svg">
                                            <path d="M1 1C1.91797 2.08433 4.89728 5.27228 6.5 7L12.5 4L19.5 13"
                                                stroke="#F04444" stroke-width="2" stroke-linecap="round"></path>
                                        </svg>
                                        <span class="text-danger me-1">45%</span> This week </p>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-xl-3 col-xxl-4">
                        <div class="card">
                            ...
                            <div class="card-body" style="position: relative;">
                                <div id="currentChart" style="min-height: 275.317px;">
                                ...
                                <div class="chart-content">
                                    <div class="d-flex justify-content-between mb-2 align-items-center">
                                        <div>
                                            ...
                                            <span class="fs-14">Income (66%)</span> </div>
                                        <div>
                                    ...
                                    <div class="d-flex justify-content-between mb-2 align-items-center">
                                        <div>
                                            <svg class="me-2" width="15" height="15" viewBox="0 0 15 15" fill="none"
                                                xmlns="http://www.w3.org/2000/svg">
                                                <rect width="15" height="15" rx="7.5" fill="#4441DE"></rect>
                                            </svg>
                                            <span class="fs-14">Spends (50%))</span> </div>
                                        <div>
                                    ...
                                    <div class="d-flex justify-content-between mb-2 align-items-center">
                                        <div>
                                            <svg class="me-2" width="15" height="15" viewBox="0 0 15 15" fill="none"
                                                xmlns="http://www.w3.org/2000/svg">
                                                <rect width="15" height="15" rx="7.5" fill="#60C695"></rect>
                                            </svg>
                                            <span class="fs-14">Installment (11%)</span> </div>
                                        <div>
                                    ...
                                    <div class="d-flex justify-content-between mb-2 align-items-center">
                                        <div>
                                            <svg class="me-2" width="15" height="15" viewBox="0 0 15 15" fill="none"
                                                xmlns="http://www.w3.org/2000/svg">
                                                <rect width="15" height="15" rx="7.5" fill="#F34F80"></rect>
                                            </svg>
                                            <span class="fs-14">Invest (23%)</span> </div>
                                        <div>
                                ...
                                <div class="resize-triggers">
                                    <div class="expand-trigger">
                                        <div style="width: 352px; height: 458px;"></div>
                                    </div>
                            ...
                            <div class="card-header pb-0 border-0 flex-wrap">
                                ...
                                <div>
                                    <select class="form-control style-2 default-select border text-primary"
                                        style="display: none;">
                                        <option selected="selected">Weekly (2020)</option>
                                        <option>Daily (2020)</option>
                                        <option>Yearly (2020)</option>
                                    </select>
                                    <div class="nice-select form-control style-2 default-select border text-primary"
                                        tabindex="0"><span class="current">Weekly (2020)</span>
                                        <ul class="list">
                                            <li data-value="Weekly (2020)" class="option selected">Weekly (2020)</li>
                                            <li data-value="Daily (2020)" class="option">Daily (2020)</li>
                                            <li data-value="Yearly (2020)" class="option">Yearly (2020)</li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
                            <div class="card-body pb-0 pt-3" style="position: relative;">
                                <div id="marketChart" class="market-line" style="min-height: 365px;">
                                   
                                </div>
                                <div class="resize-triggers">
                                    <div class="expand-trigger">
                                        <div style="width: 1114px; height: 416px;"></div>
                                    </div>
                                    <div class="contract-trigger"></div>
                                </div>
                            </div>
                        ...
                        <div class="owl-stage-outer">
                            <div class="owl-stage"
                                ...
                                <div class="owl-item active" style="width: auto; margin-right: 30px;">
                                    <div class="items">
                                        <div class="card-bx stacked card"> <img src="{{ asset('user_dashboard_assets/image/card44.jpg')}}" alt="">
                                            <div class="card-info">
                                ...
                                <div class="owl-item active" style="width: auto; margin-right: 30px;">
                                    <div class="items">
                                        <div class="card-bx stacked card"> <img src="{{ asset('user_dashboard_assets/image/card33.jpg')}}" alt="">
                                            <div class="card-info">
                                                <p class="mb-1 text-white fs-14">Main Balance</p>
                                                <div class="d-flex justify-content-between">
                                                    <h2 class="num-text text-white mb-5 font-w600">$673,412.66</h2>
                                ...
                                <div class="owl-item active" style="width: auto; margin-right: 30px;">
                                    <div class="items">
                                        <div class="card-bx stacked card"> <img src="{{ asset('user_dashboard_assets/image/card11.jpg')}}" alt="">
                                            <div class="card-info">
                                                <p class="mb-1 text-white fs-14">Main Balance</p>
                                                <div class="d-flex justify-content-between">
                                                    <h2 class="num-text text-white mb-5 font-w600">$673,412.66</h2>
                                ...
                                <div class="owl-item active" style="width: auto; margin-right: 30px;">
                                    <div class="items">
                                        <div class="card-bx stacked card"> <img src="{{ asset('user_dashboard_assets/image/card22.jpg')}}" alt="">
                                            <div class="card-info">
                                                <p class="mb-1 text-white fs-14">Main Balance</p>
                                                <div class="d-flex justify-content-between">
                                                    <h2 class="num-text text-white mb-5 font-w600">$673,412.66</h2>
                                        ...
                                        <div class="tab-content">
                                            <div class="tab-pane active show fade" id="monthly">
                                                <div class="table-responsive">
                                                    <table
                                                        class="table border-hover tr-rounded card-table cardtbl-link">
                                                        <tbody>
                                                            <tr>
                                                                <td><span>
                                                                        <svg width="63" height="63" viewBox="0 0 63 63"
                                                                            fill="none"
                                                                            xmlns="http://www.w3.org/2000/svg">
                                                                            <rect width="63" height="63" rx="31.5"
                                                                                fill="#13B440"></rect>
                                                                            <path
                                                                ...
                                                                <td class="wspace-no"><svg class="me-2" width="24"
                                                                ...
                                                                <td><a class="btn btn-outline-success float-end rounded"
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td><a class="btn btn-outline-light float-end rounded"
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td><a class="btn btn-outline-danger float-end rounded"
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td class="wspace-no"><svg class="me-1" width="24"
                                                                        height="24" viewBox="0 0 24 24" fill="none"
                                                                        xmlns="http://www.w3.org/2000/svg">
                                                                        <path
                                            ...
                                            <div class="tab-pane fade" id="Weekly">
                                                <div class="table-responsive">
                                                    <table
                                                        class="table border-hover card-table border-no tbl-btn short-one cardtbl-link">
                                                        <tbody>
                                                            <tr>
                                                                <td><span>
                                                                        <svg width="63" height="63" viewBox="0 0 63 63"
                                    ...
                                    <div class="card-header border-0 pb-0">
                                        ...
                                        <div class="dropdown custom-dropdown mb-0">
                                            ...
                                            <div class="dropdown-menu dropdown-menu-right"> <a class="dropdown-item"
                                                    href="javascript:void(0);">Details</a> <a
                                    ...
                                    <div class="card-body px-4">
                                        <div class="dropdown custom-dropdown d-block tbl-orders">
                                            <div class="btn  d-flex align-items-center border-0 order-bg rounded "
                                                ...
                                                <div class="text-start ms-3"> <span
                                                        class="d-block fs-16 text-black">Litecoin</span> </div>
                                                <i class="fa fa-angle-down scale5 ms-auto"></i>
                                            </div>
                                            <div class="dropdown-menu dropdown-menu-right"> <a class="dropdown-item"
                                                    href="javascript:void(0);">Bitcoin</a> <a class="dropdown-item"
                                                    href="javascript:void(0);">ETH coin</a> </div>
                                        </div>
                                        <div class="table-responsive">
                                    ...
                                    <div class="card-body pb-0 px-4">
                                        <div class="dropdown custom-dropdown d-block tbl-orders">
                                            <div class="btn  d-flex align-items-center order-bg border-0 rounded"
                                                ...
                                                <div class="text-left ms-3"> <span
                                                        class="d-block fs-16 text-black">Monero</span> </div>
                                                <i class="fa fa-angle-down scale5 ms-auto"></i>
                                            </div>
                                            <div class="dropdown-menu dropdown-menu-right"> <a class="dropdown-item"
                                                    href="javascript:void(0);">Dash coin</a> <a class="dropdown-item"
                                                    href="javascript:void(0);">ETH coin</a> </div>
                                        </div>
                                        <div class="table-responsive">
                                ...
                                <div class="card">
                                    <div class="card-header d-sm-flex d-block pb-0 border-0">
                                        ...
                                        <div class="quick-select">
                                            ...
                                            <select class="form-control style-2 default-select" style="display: none;">
                                                <option selected="selected">23,511 LTC</option>
                                                <option>345,455 ETH</option>
                                                <option>789,123 BTH</option>
                                            </select>
                                            <div class="nice-select form-control style-2 default-select" tabindex="0">
                                                <span class="current">23,511 LTC</span>
                                                <ul class="list">
                                                    <li data-value="23,511 LTC" class="option selected">23,511 LTC</li>
                                                    <li data-value="345,455 ETH" class="option">345,455 ETH</li>
                                                    <li data-value="789,123 BTH" class="option">789,123 BTH</li>
                                                </ul>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="card-body">
                                            ...
                                            <div class="form-group">
                                                <div class="input-group input-group-lg">
                                                    <div class="input-group-prepend"> <span
                                                            class="input-group-text">Amount BTC</span> </div>
                                        ...
                                        <div
                                            class="testimonial-two px-4 owl-carousel contacts-slider owl-loaded owl-drag">
                                            <div class="owl-stage-outer">
                                                <div class="owl-stage"
                                                    style="transform: translate3d(-742px, 0px, 0px); transition: all 0.25s ease 0s; width: 1971px; padding-left: 20px; padding-right: 20px;">
                                                    <div class="owl-item cloned"
                                                        style="width: 138.5px; margin-right: 10px;">
                                                        <div class="items">
                                                            <div class="text-center"> <img
                                                                    class="mb-3 rounded-circle mx-auto"
                                                                    src="{{ asset('user_dashboard_assets/image/pic-2.jpg')}}" alt="">
                                                    ...
                                                    <div class="owl-item cloned"
                                                        ...
                                                        <div class="items">
                                                            <div class="text-center"> <img
                                                                    class="mb-3 rounded-circle mx-auto"
                                                                    src="{{ asset('user_dashboard_assets/image/pic-3.jpg')}}" alt="">
                                                                <h5 class="mb-0"><a class="text-black"
                                                    ...
                                                    <div class="owl-item cloned"
                                                        ...
                                                        <div class="items">
                                                            <div class="text-center"> <img
                                                                    class="mb-3 rounded-circle mx-auto"
                                                                    src="{{ asset('user_dashboard_assets/image/pic-4.jpg')}}" alt="">
                                                                <h5 class="mb-0"><a class="text-black"
                                                    ...
                                                    <div class="owl-item cloned"
                                                        ...
                                                        <div class="items">
                                                            <div class="text-center"> <img
                                                                    class="mb-3 rounded-circle mx-auto"
                                                                    src="{{ asset('user_dashboard_assets/image/pic-7.jpg')}}" alt="">
                                                                <h5 class="mb-0"><a class="text-black"
                                                    ...
                                                    <div class="owl-item" style="width: 138.5px; margin-right: 10px;">
                                                        <div class="items">
                                                            <div class="text-center"> <img
                                                                    class="mb-3 rounded-circle mx-auto"
                                                                    src="{{ asset('user_dashboard_assets/image/pic-5.jpg')}}" alt="">
                                                                <h5 class="mb-0"><a class="text-black"
                                        ...
                                        <div class="row pt-5 align-items-center">
                                            ...
                                            <div class="col-sm-6"> <a href="javascript:void(0);"
                                                    class="btn btn-primary d-block btn-lg rounded">TRANSFER NOW</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                        ...
                                        <div class="basic-form">
                                            <form class="form-wrapper">
                                                ...
                                                <div class="form-group">
                                                    <div class="input-group input-group-lg">
                                                        <div class="input-group-prepend"> <span
                                                                class="input-group-text ">Price BPL</span> </div>
                                                ...
                                                <div class="form-group">
                                                    <div class="input-group input-group-lg">
                                                        <div class="input-group-prepend"> <span
                                                                class="input-group-text">Fee (1%)</span> </div>
                                                        <input type="number" class="form-control">
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                    <div class="input-group input-group-lg">
                                                        <div class="input-group-prepend"> <span
                                                                class="input-group-text">Total BPL</span> </div>
                                                        <input type="number" class="form-control">
                                                    </div>
                                                </div>
                                                <div class="row mt-4 align-items-center">
                                                    ...
                                                    <div class="col-lg-6">
                                                        <div class="d-flex justify-content-end"> <a
                                                                href="javascript:void(0);"
                                                                class="btn  btn-success text-white rounded"> BUY
                                                                <svg class="ms-4 scale3" width="16" height="16"
                                                                ...
                                                                class="btn btn-danger ms-3 rounded"> SELL
                                                                <svg class="ms-4 scale5" width="16" height="16"
    ...
    ***********************************-->
    <!-- Required vendors -->
    <script src="{{ asset('user_dashboard_assets/js/global.js') }}"></script>
    <script src="{{ asset('user_dashboard_assets/js/Chart.js') }}"></script>
    <script src="{{ asset('user_dashboard_assets/js/jquery.js') }}"></script>

    <!-- Apex Chart -->
    <script src="{{ asset('user_dashboard_assets/js/apexchart.js') }}"></script>
    <script src="{{ asset('user_dashboard_assets/js/owl.js') }}"></script>

    <!-- Dashboard 1 -->
    <script src="{{ asset('user_dashboard_assets/js/dashboard-1.js') }}"></script>
    <script src="{{ asset('user_dashboard_assets/js/custom.js') }}"></script>
    <script src="{{ asset('user_dashboard_assets/js/deznav-init.js') }}"></script>
    <script src="{{ asset('user_dashboard_assets/js/demo.js') }}"></script>
    <script src="{{ asset('user_dashboard_assets/js/styleSwitcher.js') }}"></script>
    <div class="sidebar-right">
        ...
        <div class="sidebar-right-inner">
            <h4>Pick your style <a href="javascript:void(0);" onclick="deleteAllCookie()"
                    class="btn btn-primary btn-sm pull-right">Delete All Cookie</a></h4>
            <div class="card-tabs">
                <ul class="nav nav-tabs" role="tablist">
                    ...
                    <div class="admin-settings">
                        <div class="row">
                            <div class="col-sm-12">
                                ...
                                <div class="nice-select default-select wide form-control" tabindex="0"><span
                                        class="current">Light</span>
                                    <ul class="list">
                            ...
                            <div class="col-sm-6">
                                <p>Primary Color</p>
                                <div> <span data-placement="top" data-bs-toggle="tooltip" title="Color 1">
                                        <input class="chk-col-primary filled-in" id="primary_color_1" name="primary_bg"
                                            type="radio" value="color_1">
                                        <label for="primary_color_1" class="bg-label-pattern"></label>
                                    </span> <span>
                                        <input class="chk-col-primary filled-in" id="primary_color_2" name="primary_bg"
                                            type="radio" value="color_2">
                                        <label for="primary_color_2"></label>
                                    </span> <span>
                                        <input class="chk-col-primary filled-in" id="primary_color_3" name="primary_bg"
                                            type="radio" value="color_3">
                                        <label for="primary_color_3"></label>
                                    </span> <span>
                                        <input class="chk-col-primary filled-in" id="primary_color_4" name="primary_bg"
                                            type="radio" value="color_4">
                                        <label for="primary_color_4"></label>
                                    </span> <span>
                                        <input class="chk-col-primary filled-in" id="primary_color_5" name="primary_bg"
                                            type="radio" value="color_5">
                                        <label for="primary_color_5"></label>
                                    </span> <span>
                                        <input class="chk-col-primary filled-in" id="primary_color_6" name="primary_bg"
                                            type="radio" value="color_6">
                                        <label for="primary_color_6"></label>
                                    </span> <span>
                                        <input class="chk-col-primary filled-in" id="primary_color_7" name="primary_bg"
                                            type="radio" value="color_7">
                                        <label for="primary_color_7"></label>
                                    </span> <span>
                                        <input class="chk-col-primary filled-in" id="primary_color_9" name="primary_bg"
                                            type="radio" value="color_9">
                                        <label for="primary_color_9"></label>
                                    </span> <span>
                                        <input class="chk-col-primary filled-in" id="primary_color_10" name="primary_bg"
                                            type="radio" value="color_10">
                                        <label for="primary_color_10"></label>
                                    </span> <span>
                                        <input class="chk-col-primary filled-in" id="primary_color_11" name="primary_bg"
                                            type="radio" value="color_11">
                                        <label for="primary_color_11"></label>
                                    </span> <span>
                                        <input class="chk-col-primary filled-in" id="primary_color_12" name="primary_bg"
                                            type="radio" value="color_12">
                                        <label for="primary_color_12"></label>
                                    </span> <span>
                                        <input class="chk-col-primary filled-in" id="primary_color_13" name="primary_bg"
                                            type="radio" value="color_13">
                                        <label for="primary_color_13"></label>
                                    </span> <span>
                                        <input class="chk-col-primary filled-in" id="primary_color_14" name="primary_bg"
                                            type="radio" value="color_14">
                                        <label for="primary_color_14"></label>
                                    </span> <span>
                                        <input class="chk-col-primary filled-in" id="primary_color_15" name="primary_bg"
                                            type="radio" value="color_15">
                            ...
                            <div class="col-sm-6">
                                ...
                                <div> <span>
                                        <input class="chk-col-primary filled-in" id="nav_header_color_1"
                                            name="navigation_header" type="radio" value="color_1">
                                        <label for="nav_header_color_1" class="bg-label-pattern"></label>
                                    </span> <span>
                                        <input class="chk-col-primary filled-in" id="nav_header_color_2"
                                            name="navigation_header" type="radio" value="color_2">
                                        <label for="nav_header_color_2"></label>
                                    </span> <span>
                                        <input class="chk-col-primary filled-in" id="nav_header_color_3"
                                            name="navigation_header" type="radio" value="color_3">
                                        <label for="nav_header_color_3"></label>
                                    </span> <span>
                                        <input class="chk-col-primary filled-in" id="nav_header_color_4"
                                            name="navigation_header" type="radio" value="color_4">
                                        <label for="nav_header_color_4"></label>
                                    </span> <span>
                                        <input class="chk-col-primary filled-in" id="nav_header_color_5"
                                            name="navigation_header" type="radio" value="color_5">
                                        <label for="nav_header_color_5"></label>
                                    </span> <span>
                                        <input class="chk-col-primary filled-in" id="nav_header_color_6"
                                            name="navigation_header" type="radio" value="color_6">
                                        <label for="nav_header_color_6"></label>
                                    </span> <span>
                                        <input class="chk-col-primary filled-in" id="nav_header_color_7"
                                            name="navigation_header" type="radio" value="color_7">
                                        <label for="nav_header_color_7"></label>
                                    </span> <span>
                                        <input class="chk-col-primary filled-in" id="nav_header_color_8"
                                            name="navigation_header" type="radio" value="color_8">
                                        <label for="nav_header_color_8" class="border"></label>
                                    </span> <span>
                                        <input class="chk-col-primary filled-in" id="nav_header_color_9"
                                            name="navigation_header" type="radio" value="color_9">
                                        <label for="nav_header_color_9"></label>
                                    </span> <span>
                                        <input class="chk-col-primary filled-in" id="nav_header_color_10"
                                            name="navigation_header" type="radio" value="color_10">
                                        <label for="nav_header_color_10"></label>
                                    </span> <span>
                                        <input class="chk-col-primary filled-in" id="nav_header_color_11"
                                            name="navigation_header" type="radio" value="color_11">
                                        <label for="nav_header_color_11"></label>
                                    </span> <span>
                                        <input class="chk-col-primary filled-in" id="nav_header_color_12"
                                            name="navigation_header" type="radio" value="color_12">
                                        <label for="nav_header_color_12"></label>
                                    </span> <span>
                                        <input class="chk-col-primary filled-in" id="nav_header_color_13"
                                            name="navigation_header" type="radio" value="color_13">
                                        <label for="nav_header_color_13"></label>
                                    </span> <span>
                                        <input class="chk-col-primary filled-in" id="nav_header_color_14"
                                            name="navigation_header" type="radio" value="color_14">
                                        <label for="nav_header_color_14"></label>
                                    </span> <span>
                                        <input class="chk-col-primary filled-in" id="nav_header_color_15"
                                            name="navigation_header" type="radio" value="color_15">
                            ...
                            <div class="col-sm-6">
                                <p>Header</p>
                                <div> <span>
                                        <input class="chk-col-primary filled-in" id="header_color_1" name="header_bg"
                                            type="radio" value="color_1">
                                        <label for="header_color_1" class="bg-label-pattern"></label>
                                    </span> <span>
                                        <input class="chk-col-primary filled-in" id="header_color_2" name="header_bg"
                                            type="radio" value="color_2">
                                        <label for="header_color_2"></label>
                                    </span> <span>
                                        <input class="chk-col-primary filled-in" id="header_color_3" name="header_bg"
                                            type="radio" value="color_3">
                                        <label for="header_color_3"></label>
                                    </span> <span>
                                        <input class="chk-col-primary filled-in" id="header_color_4" name="header_bg"
                                            type="radio" value="color_4">
                                        <label for="header_color_4"></label>
                                    </span> <span>
                                        <input class="chk-col-primary filled-in" id="header_color_5" name="header_bg"
                                            type="radio" value="color_5">
                                        <label for="header_color_5"></label>
                                    </span> <span>
                                        <input class="chk-col-primary filled-in" id="header_color_6" name="header_bg"
                                            type="radio" value="color_6">
                                        <label for="header_color_6"></label>
                                    </span> <span>
                                        <input class="chk-col-primary filled-in" id="header_color_7" name="header_bg"
                                            type="radio" value="color_7">
                                        <label for="header_color_7"></label>
                                    </span> <span>
                                        <input class="chk-col-primary filled-in" id="header_color_8" name="header_bg"
                                            type="radio" value="color_8">
                                        <label for="header_color_8" class="border"></label>
                                    </span> <span>
                                        <input class="chk-col-primary filled-in" id="header_color_9" name="header_bg"
                                            type="radio" value="color_9">
                                        <label for="header_color_9"></label>
                                    </span> <span>
                                        <input class="chk-col-primary filled-in" id="header_color_10" name="header_bg"
                                            type="radio" value="color_10">
                                        <label for="header_color_10"></label>
                                    </span> <span>
                                        <input class="chk-col-primary filled-in" id="header_color_11" name="header_bg"
                                            type="radio" value="color_11">
                                        <label for="header_color_11"></label>
                                    </span> <span>
                                        <input class="chk-col-primary filled-in" id="header_color_12" name="header_bg"
                                            type="radio" value="color_12">
                                        <label for="header_color_12"></label>
                                    </span> <span>
                                        <input class="chk-col-primary filled-in" id="header_color_13" name="header_bg"
                                            type="radio" value="color_13">
                                        <label for="header_color_13"></label>
                                    </span> <span>
                                        <input class="chk-col-primary filled-in" id="header_color_14" name="header_bg"
                                            type="radio" value="color_14">
                                        <label for="header_color_14"></label>
                                    </span> <span>
                                        <input class="chk-col-primary filled-in" id="header_color_15" name="header_bg"
                                            type="radio" value="color_15">
                            ...
                            <div class="col-sm-6">
                                <p>Sidebar</p>
                                <div> <span>
                                        <input class="chk-col-primary filled-in" id="sidebar_color_1" name="sidebar_bg"
                                            type="radio" value="color_1">
                                        <label for="sidebar_color_1" class="bg-label-pattern"></label>
                                    </span> <span>
                                        <input class="chk-col-primary filled-in" id="sidebar_color_2" name="sidebar_bg"
                                            type="radio" value="color_2">
                                        <label for="sidebar_color_2"></label>
                                    </span> <span>
                                        <input class="chk-col-primary filled-in" id="sidebar_color_3" name="sidebar_bg"
                                            type="radio" value="color_3">
                                        <label for="sidebar_color_3"></label>
                                    </span> <span>
                                        <input class="chk-col-primary filled-in" id="sidebar_color_4" name="sidebar_bg"
                                            type="radio" value="color_4">
                                        <label for="sidebar_color_4"></label>
                                    </span> <span>
                                        <input class="chk-col-primary filled-in" id="sidebar_color_5" name="sidebar_bg"
                                            type="radio" value="color_5">
                                        <label for="sidebar_color_5"></label>
                                    </span> <span>
                                        <input class="chk-col-primary filled-in" id="sidebar_color_6" name="sidebar_bg"
                                            type="radio" value="color_6">
                                        <label for="sidebar_color_6"></label>
                                    </span> <span>
                                        <input class="chk-col-primary filled-in" id="sidebar_color_7" name="sidebar_bg"
                                            type="radio" value="color_7">
                                        <label for="sidebar_color_7"></label>
                                    </span> <span>
                                        <input class="chk-col-primary filled-in" id="sidebar_color_8" name="sidebar_bg"
                                            type="radio" value="color_8">
                                        <label for="sidebar_color_8" class="border"></label>
                                    </span> <span>
                                        <input class="chk-col-primary filled-in" id="sidebar_color_9" name="sidebar_bg"
                                            type="radio" value="color_9">
                                        <label for="sidebar_color_9"></label>
                                    </span> <span>
                                        <input class="chk-col-primary filled-in" id="sidebar_color_10" name="sidebar_bg"
                                            type="radio" value="color_10">
                                        <label for="sidebar_color_10"></label>
                                    </span> <span>
                                        <input class="chk-col-primary filled-in" id="sidebar_color_11" name="sidebar_bg"
                                            type="radio" value="color_11">
                                        <label for="sidebar_color_11"></label>
                                    </span> <span>
                                        <input class="chk-col-primary filled-in" id="sidebar_color_12" name="sidebar_bg"
                                            type="radio" value="color_12">
                                        <label for="sidebar_color_12"></label>
                                    </span> <span>
                                        <input class="chk-col-primary filled-in" id="sidebar_color_13" name="sidebar_bg"
                                            type="radio" value="color_13">
                                        <label for="sidebar_color_13"></label>
                                    </span> <span>
                                        <input class="chk-col-primary filled-in" id="sidebar_color_14" name="sidebar_bg"
                                            type="radio" value="color_14">
                                        <label for="sidebar_color_14"></label>
                                    </span> <span>
                                        <input class="chk-col-primary filled-in" id="sidebar_color_15" name="sidebar_bg"
                                            type="radio" value="color_15">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-6">
                                ...
                                <select class="default-select wide form-control" id="header_position"
                                    name="header_position" style="display: none;">
                                    <option value="static" selected="selected">Static</option>
                                    <option value="fixed">Fixed</option>
                                </select>
                                <div class="nice-select default-select wide form-control" tabindex="0"><span
                                        class="current">Static</span>
                                    <ul class="list">
                            ...
                            <div class="col-sm-6">
                                ...
                                <select class="default-select wide form-control" id="sidebar_position"
                                    name="sidebar_position" style="display: none;">
                                    <option value="static" selected="selected">Static</option>
                                    <option value="fixed">Fixed</option>
                                </select>
                                <div class="nice-select default-select wide form-control" tabindex="0"><span
                        ...
                        <div class="row">
                            <div class="col-sm-6">
                                ...
                                <select class="default-select wide form-control" id="container_layout"
                                    name="container_layout" style="display: none;">
                                    <option value="wide" selected="selected">Wide</option>
                                    <option value="boxed">Boxed</option>
                                    <option value="wide-boxed">Wide Boxed</option>
                                </select>
                                <div class="nice-select default-select wide form-control" tabindex="0"><span
                                        class="current">Wide</span>
                                    <ul class="list">
    ...
    <div class="dz-demo-panel">
        ...
        <a class="dz-demo-trigger" data-toggle="tooltip" data-placement="right"
            data-original-title="Check out more demos" href="javascript:void(0)"><span><i
                    class="las la-tint"></i></span></a>
        <div class="dz-demo-inner"><a href="javascript:void(0);" class="btn btn-primary btn-sm px-2 py-1 mb-3"
            ...
            <div class="dz-demo-content ps ps--active-y">
                <div class="dz-wrapper">
                    <div class="overlay-bx  dz-demo-bx demo-active">
                        <div class="overlay-wrapper "><img src="{{ asset('user_dashboard_assets/image/pic1_002.jpg')}}" alt="" class="w-100"></div>
                        <div class="overlay-layer"><a href="javascript:void(0);" data-theme="1"
                                class="btn dz_theme_demo btn-secondary btn-sm mr-2">Demo-1</a></div>
                    </div>
                    <h5 class="text-black">Demo 1</h5>
                    <hr>
                    <div class="overlay-bx  dz-demo-bx">
                        <div class="overlay-wrapper "><img src="{{ asset('user_dashboard_assets/image/pic2.jpg')}}" alt="" class="w-100"></div>
                        <div class="overlay-layer"><a href="javascript:void(0);" data-theme="2"
                                class="btn dz_theme_demo btn-secondary btn-sm mr-2">Demo-2</a></div>
                    </div>
                    <h5 class="text-black">Demo 2</h5>
                    <hr>
                    <div class="overlay-bx  dz-demo-bx">
                        <div class="overlay-wrapper "><img src="{{ asset('user_dashboard_assets/image/pic3.jpg')}}" alt="" class="w-100"></div>
                        <div class="overlay-layer"><a href="javascript:void(0);" data-theme="3"
                                class="btn dz_theme_demo btn-secondary btn-sm mr-2">Demo-3</a></div>
                    </div>
                    <h5 class="text-black">Demo 3</h5>
                    <hr>
                    <div class="overlay-bx  dz-demo-bx">
                        <div class="overlay-wrapper "><img src="{{ asset('user_dashboard_assets/image/pic4.jpg')}}" alt="" class="w-100"></div>
                        <div class="overlay-layer"><a href="javascript:void(0);" data-theme="4"
                                class="btn dz_theme_demo btn-secondary btn-sm mr-2">Demo-4</a></div>
                    </div>
                    <h5 class="text-black">Demo 4</h5>
                    <hr>
                    <div class="overlay-bx  dz-demo-bx">
                        <div class="overlay-wrapper "><img src="{{ asset('user_dashboard_assets/image/pic5.jpg')}}" alt="" class="w-100"></div>
                        <div class="overlay-layer"><a href="javascript:void(0);" data-theme="5"
                                class="btn dz_theme_demo btn-secondary btn-sm mr-2">Demo-5</a></div>
                    </div>
                    <h5 class="text-black">Demo 5</h5>
                </div>
                <div class="ps__rail-x" style="left: 0px; bottom: 0px;">
                    <div class="ps__thumb-x" tabindex="0" style="left: 0px; width: 0px;"></div>
                </div>
                <div class="ps__rail-y" style="top: 0px; height: 815px; right: 0px;">
                    <div class="ps__thumb-y" tabindex="0" style="top: 0px; height: 516px;"></div>
                </div>
            </div>
            <div class="fs-12 pt-3"><span class="text-danger">*Note :</span> This theme switcher is not part of product.
                It is only for demo. you will get all guideline in documentation. please check <a
                    href="javascript:void(0);" class="text-primary">documentation.</a></div>
        </div>
    </div>
